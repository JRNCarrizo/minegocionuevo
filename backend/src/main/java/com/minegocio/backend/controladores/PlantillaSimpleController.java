...
/**
 * Controlador simple para plantilla de Excel
 */
@RestController
public class PlantillaSimpleController {

    /**
     * Endpoint simple para plantilla de Excel
     */
    ...
    public void descargarPlantilla(HttpServletResponse response) throws IOException {
        try {
            ...
            System.err.println("❌ Error en plantilla simple: " + e.getMessage());
            e.printStackTrace();

...
/**
 * Controlador completamente independiente para plantilla de Excel
 * No usa Spring Security, no pasa por filtros
 */
@RestController
@RequestMapping("/public/plantilla")
@CrossOrigin(origins = "*")
public class PlantillaPublicaController {

    /**
     * Endpoint completamente independiente para plantilla de Excel
     */
    @RequestMapping(value = "/excel", method = RequestMethod.GET)
    public void descargarPlantillaIndependiente(HttpServletResponse response) throws IOException {
        try {
            System.out.println("📥 Descargando plantilla independiente");
            ...
            System.out.println("✅ Plantilla independiente generada exitosamente");
        } catch (Exception e) {
            System.err.println("❌ Error en plantilla independiente: " + e.getMessage());
            e.printStackTrace();
